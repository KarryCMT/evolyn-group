...
defineOptions({ name: 'AppIconPicker' });
...
<template>
  <el-popover
    ...
    popper-class="app-icon-picker__popper"
  ...
  >
    <template #reference>
      <button class="app-icon-picker" type="button" aria-label="修改图标" :style="previewStyle">
...
.app-icon-picker__popper.el-popper {
  padding: 0;
  border: 0;
