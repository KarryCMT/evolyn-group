...
import AppWorkspaceFormRuntime from '../AppWorkspaceFormRuntime.vue';
...
describe('appWorkspaceFormRuntime', () => {
  it('资产切换取消旧请求，且迟到响应不会覆盖当前表单', async () => {
    ...
    const wrapper = mount(AppWorkspaceFormRuntime, {
