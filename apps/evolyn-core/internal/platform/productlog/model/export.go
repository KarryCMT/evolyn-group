...
func (f *FiltersJSON) Scan(v interface{}) error {
	...
	case string:
		*f = FiltersJSON(data)
	default:
		return fmt.Errorf("cannot scan %T into productlog.FiltersJSON", v)
	}
	return nil
}

// ExportTask 产品日志导出任务（tn_product_log_exports，000064）：追加型任务
...
func (*ExportTask) TableName() string { return "tn_product_log_exports" }
